  ...
  return (
    ...
    >
      <div
        ...
        className="flex max-h-[70vh] w-[520px] flex-col rounded-[6px] border border-border bg-bg-elevated shadow-pop"
      >
        <div className="flex h-11 shrink-0 items-center gap-2 border-b border-border px-4">
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <button
              ...
              aria-label="Close"
              onClick={onClose}
              className="rounded-[3px] px-1.5 text-[14px] text-text-muted hover:text-text-primary"
            >
              ×
            </button>
          </div>
                ...
                >
                  ...
                  {!isOpen && (
                    <button
                      ...
                      className={`rounded-[4px] p-1.5 transition-colors duration-[120ms] ${
                        armedDelete === p.id
